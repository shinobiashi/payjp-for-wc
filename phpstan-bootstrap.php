...
defined( 'PAYJP_FOR_WC_FILE' ) || define( 'PAYJP_FOR_WC_FILE', dirname( __FILE__ ) . '/payjp-for-wc.php' );
defined( 'PAYJP_FOR_WC_DIR' ) || define( 'PAYJP_FOR_WC_DIR', dirname( __FILE__ ) . '/' );
defined( 'PAYJP_FOR_WC_URL' ) || define( 'PAYJP_FOR_WC_URL', 'http://example.com/wp-content/plugins/payjp-for-wc/' );
